    ...
    return (
        <main className="flex lg:mt-20 flex-col lg:flex-row
         items-center justify-between min-h-[calc(90vh-6rem)]">
            <div className="max-w-xl ml-[5%] z-10 mt-[50%]
            md:mt-[40%] lg:mt-0 mb-10"
                 data-aos="fade-right"
                 data-aos-offset="300"
            ...
            >
              ...
              >
                ...
                <div className="flex gap-4 mt-12">
                    <a href="#" className="border border-[#2a2a2a] py-2
                     sm:py-3 px-4 sm:px-5 rounded-full sm:text-lg text-sm
                     font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a]
                    ...
                    <a href="#" className="border border-[#2a2a2a] py-2
                     sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg text-sm
            ...
            <Spline className="absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%]
            sm:left-[-2%] h-full"
                    data-aos="zoom-in"
                    ...
                    scene="https://prod.spline.design/s5nCvVoYTlcbBZqm/scene.splinecode" />
